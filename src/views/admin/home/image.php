            ...
            <tr>
                ...
                <?php for ($i=1; $i <= 6 ; $i++) {  ?>
                        <form id="upload_form" enctype="multipart/form-data" method="post">
                            ...
                            <?php if (file_exists(UPLOAD . "home/sample/" . "image_" . $i . ".jpg")) { ?>
                                <a class="showpic" href="<?php echo ORIGIN . 'public/upload/home/sample/' . "image_" . $i . ".jpg" ?>" target="__blank">مشاهده عکس</a>
                            <?php } ?>
                        </form>
                <?php } ?>
                </td>
            ...
            <tr>
                ...
                <?php for ($i=1; $i <= 6 ; $i++) {  ?>
                        <form id="upload_form" enctype="multipart/form-data" method="post">
                            ...
                            <p id="status"></p>
                            <p id="loaded_n_total"></p>
                            <?php if (file_exists(UPLOAD . "home/hero/" . "image_" . $i . ".jpg")) { ?>
                                <a class="showpic" href="<?php echo ORIGIN . 'public/upload/home/hero/' . "image_" . $i . ".jpg" ?>" target="__blank">مشاهده عکس</a>
                            <?php } ?>
                        </form>
                <?php } ?>
                </td>
